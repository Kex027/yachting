export const translationsEN = {
  translation: {
    ...
    Contact: "Contact",
    "Encouragement text":
      "A date, family adventure, office integration, perhaps a day out with friends? With our team and flexible offer you’re up for a great time!",
    ...
    "Footer copyright": "© 2024 WestMar Boats Gdynia. All rights reserved.",
    ...
    "0-15 knots": "0-15 knots",
    "0-35 knots": "0-35 knots",
    knots: "knots",
...
export const translationsPL = {
  translation: {
    ...
    Contact: "Kontakt",
    "Encouragement text":
      "Randka, rodzinna przejażdżka, integracja firmowa, a może wypad z przyjaciółmi? Z naszą ekipą i szerokim wachlarzem oferty, spędzisz nie zapomniane chwile!",
    ...
    "Footer copyright":
      "© 2024 WestMar Boats Gdynia. Wszelkie prawa zastrzeżone.",
    ...
    Call: "Zadzwoń",
    "Offer 1 title": "Skipper",
    "Offer 2 title": "Żegluj  do woli",
    "Offer 3 title": "Dodatkowe udogodnienia",
    "Offer 1 description":
      "W cenie wynajmu zapewniona jest profesjonalna obsługa wykwalifikowanych sterników, dzięki czemu możesz w pełni zrelaksować się i cieszyć rejsem, podziwiając akwen Zatoki Gdańskiej.",
    "Offer 2 description":
      "Jesteśmy elastyczni! Możesz wynająć łódź na standardową trasę z naszej oferty lub popłynąć, gdzie zechcesz! Zadzwoń lub wyślij wiadomość — dostosujemy ofertę do Twoich potrzeb.",
    "Offer 3 description":
      "Rezerwując przejażdżkę naszą łodzią, możesz zamówić odbiór luksusową limuzyną BMW z dowolnej lokalizacji na terenie Trójmiasta. Przy długim rejsie możesz zgłodnieć, na Twoją prośbę zorganizujemy poczęstunek w postaci sushi i napojów!",
